...
final List<Page> pages = [
  ...
  Page("/app/info", const InfoPage(),
      icon: CupertinoIcons.info_circle, inList: false),
  Page("/auth/login", LoginPage(), icon: CupertinoIcons.home, inList: false),
  Page("/auth/resetPass", const ResetPassPage(),
      icon: CupertinoIcons.home, inList: false),
  Page("/admin/settings", const AdminSettingsPage(),
      icon: CupertinoIcons.home, inList: false),
  ...
  Page("/order/checkout", const CheckoutPage(),
      icon: CupertinoIcons.home, inList: false),
  Page("/order", const OrderPage(), icon: CupertinoIcons.home, inList: false),
  Page("/order/checkout/payment", const PaymentPage(),
      icon: CupertinoIcons.home, inList: false),
  Page("/about", const AboutPage(),
      icon: CupertinoIcons.info_circle, isAction: true),
  Page("/account", const AccountPage(),
      icon: CupertinoIcons.info_circle, isAction: true),
  Page("/account/profile", const ProfilePage(),
      icon: CupertinoIcons.info_circle, isAction: true),
  Page("/account/settings", const SettingsPage(),
      icon: CupertinoIcons.info_circle, isAction: true),
];
...
final dio = Dio();
const String apiURL =
    false ? "https://tukoffee.vercel.app" : "http://172.16.10.204:8000";
